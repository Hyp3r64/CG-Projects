...
glBegin(GL_LINES);// rope near left stand
glColor3ub(62, 59, 59);
...
glBegin(GL_LINES);//rope near right pole
glColor3ub(0, 0, 0);
glVertex2f(0.722, 0.27);
glVertex2f(0.72, 0.256);
glVertex2f(0.72, 0.256);
glVertex2f(0.718, 0.246);
glVertex2f(0.718, 0.246);
glVertex2f(0.717, 0.238);
glVertex2f(0.717, 0.238);
glVertex2f(0.716, 0.232);
glVertex2f(0.716, 0.232);
glVertex2f(0.714, 0.224);
glVertex2f(0.714, 0.224);
glVertex2f(0.712, 0.219);
glVertex2f(0.712, 0.219);
glVertex2f(0.71, 0.214);
glVertex2f(0.71, 0.214);
glVertex2f(0.708, 0.211);
glVertex2f(0.708, 0.211);
glVertex2f(0.705, 0.209);
glVertex2f(0.705, 0.209);
glVertex2f(0.701, 0.209);
glVertex2f(0.701, 0.209);
glVertex2f(0.698, 0.211);
glVertex2f(0.698, 0.211);
glVertex2f(0.696, 0.215);
glVertex2f(0.696, 0.215);
glVertex2f(0.694, 0.2195);
glVertex2f(0.694, 0.2195);
glVertex2f(0.692, 0.226);
glVertex2f(0.692, 0.226);
glVertex2f(0.69, 0.234);
glVertex2f(0.69, 0.234);
glVertex2f(0.689, 0.241);
glVertex2f(0.689, 0.241);
glVertex2f(0.688, 0.249);
glVertex2f(0.688, 0.249);
glVertex2f(0.6865, 0.258);
glVertex2f(0.6865, 0.258);
...
//glutTimerFunc(10000,day_loop,0);
glFlush();
}
...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow("Chittagong Port @ Midday    ||     Project by: Arik . Eraz . Nowrin . Saidul . Mahin");
    glutDisplayFunc(day);
